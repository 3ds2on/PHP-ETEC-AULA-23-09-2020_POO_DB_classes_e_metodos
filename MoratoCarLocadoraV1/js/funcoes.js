...
//CHECA SE APENAS UM MODELO FOI SELECIONADO
if(txtCompacto.trim() == 'A' && txtSedan.trim() == 'A' && txtPikup.trim() == 'A' && txtHatch.trim() == 'A' && txtSuv.trim() == 'A'){
...
//CHECA SE OS DADOS PESSOAIS FORAM PREENCHIDOS
